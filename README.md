This project is an in-memory asset registry and cache written in modern C++ (C++20), designed to manage the lifecycle of assets with precise control over memory usage and eviction. 
